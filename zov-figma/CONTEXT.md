...
График динамики цены (buildPricePlot):
  ...
  - Выбор периода: inline pill-chips [1Д] [1Н] [1М] [1Г]
  - Высота 120dp
...
scrollBody:
  ...
  «Тип заявки» label
  Radio-группа: ● Рыночная  ○ Лимитная
  (если лимитная — поле ввода цены)
...
«Уведомления»:
  Toggle-строка: Уведомления о сделках  [toggle ON/OFF visual]
  Toggle-строка: Курсовые уведомления

Разделитель

«Безопасность»:
  Toggle-строка: Вход по отпечатку

Разделитель

«Валюта отображения»:
  Radio inline: ● ₽ Рубль  ○ $ Доллар  ○ € Евро
