...
VALUES (generateUUIDv4(), 'SBER', 'Сбербанк', 'Крупнейший банк России и Восточной Европы', 'stock', 'MOEX', 'Финансы',
       ...
       (generateUUIDv4(), 'WELT', 'Welt', 'Застройщик премиум-класса', 'stock', 'MOEX', 'Металлургия', 100),
       (generateUUIDv4(), 'PIK', 'ПИК', 'Крупнейший застройщик России', 'stock', 'MOEX', 'Металлургия', 10),
       (generateUUIDv4(), 'MRKK', 'Мираторг', 'Агропромышленный холдинг', 'stock', 'SPB', 'Энергетика', 100),
       ...
       (generateUUIDv4(), 'PIKB1', 'ПИК БО-001P-04', 'Облигации ПИК серии 04', 'bond', 'MOEX', 'Металлургия', 1000),
       ...
       (generateUUIDv4(), 'ETLN', 'Эталон', 'Застройщик жилой недвижимости', 'stock', 'MOEX', 'Металлургия', 100),
       (generateUUIDv4(), 'RSTI', 'Рости Агро', 'Агропромышленная компания', 'stock', 'SPB', 'Энергетика', 10);